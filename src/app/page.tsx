export default function Home() {
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-full h-64 bg-gradient-to-b from-secondary/20 to-transparent -z-10"></div>
      <div className="absolute bottom-0 left-0 w-full h-64 bg-gradient-to-t from-tertiary/10 to-transparent -z-10"></div>
      <div className="absolute top-40 right-10 w-64 h-64 rounded-full bg-secondary/20 blur-3xl -z-10"></div>
      <div className="absolute bottom-40 left-10 w-48 h-48 rounded-full bg-tertiary/10 blur-3xl -z-10"></div>
      
      {/* Navbar */}
      <nav className="fixed top-0 left-0 right-0 backdrop-blur-sm bg-background/70 z-10 border-b border-accent/20">
        <div className="max-w-3xl mx-auto px-4 py-3 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium text-accent">Dito</span>
          </div>
      ...
      <main className="min-h-screen flex flex-col px-4 py-16 pt-24 md:px-8 md:py-24 md:pt-32 max-w-3xl mx-auto relative">
        <header className="mb-12 flex items-center gap-4">
          <div className="relative">
            <h1 className="text-3xl md:text-4xl font-bold tracking-tight mb-2 bg-gradient-to-r from-accent to-tertiary bg-clip-text text-transparent">Putra Dinantio</h1>
            <p className="text-foreground flex items-center gap-2">
              Political Science Student
              <span className="inline-block w-5 h-5 rounded-full border border-accent animate-pulse bg-light-accent"></span>
            </p>
            <div className="absolute -right-12 -top-8 opacity-20 rotate-12">
        ...
        <section id="about" className="mb-12 group">
          <h2 className="text-xl font-semibold mb-4 border-b border-light-accent pb-2 flex items-center">
            <span className="relative text-accent">About Me
          ...
          <div className="pl-0 transition-all duration-300 group-hover:pl-2 border-l-0 group-hover:border-l-2 border-accent/50">
            <p className="mb-4">
            ...
            <p className="relative">
              ...
              <span className="absolute -right-8 bottom-0 text-xs text-secondary">✨ Dito</span>
            </p>
          </div>
        </section>
        ...
        <section id="education" className="mb-12 group">
          <h2 className="text-xl font-semibold mb-4 border-b border-light-accent pb-2 flex items-center">
            <span className="relative text-accent">Education
              <span className="absolute -left-4 top-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-accent opacity-0 group-hover:opacity-100 transition-opacity"></span>
            </span>
          </h2>
          <div className="pl-0 transition-all duration-300 group-hover:pl-2 border-l-0 group-hover:border-l-2 border-accent/50">
            <div className="mb-4 p-4 rounded-lg bg-light-accent/30">
        ...
        <section id="research" className="mb-12 group">
          <h2 className="text-xl font-semibold mb-4 border-b border-light-accent pb-2 flex items-center">
            <span className="relative text-accent">Research Interests
              <span className="absolute -left-4 top-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-accent opacity-0 group-hover:opacity-100 transition-opacity"></span>
            </span>
          </h2>
          <div className="pl-0 transition-all duration-300 group-hover:pl-2 border-l-0 group-hover:border-l-2 border-accent/50">
            <ul className="space-y-2">
              {["Comparative politics", "Political institutions", "Public policy analysis", "Democratic systems", "Political economy"].map((item, index) => (
                <li key={index} className="flex items-center gap-2 p-2 rounded hover:bg-light-accent/30 transition-colors">
        ...
        <section id="contact" className="group">
          <h2 className="text-xl font-semibold mb-4 border-b border-light-accent pb-2 flex items-center">
            <span className="relative text-accent">Contact
              <span className="absolute -left-4 top-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-accent opacity-0 group-hover:opacity-100 transition-opacity"></span>
            </span>
          </h2>
          <div className="pl-0 transition-all duration-300 group-hover:pl-2 border-l-0 group-hover:border-l-2 border-accent/50">
            <div className="flex flex-col gap-2">
              {[
                ...
                <p key={index} className="transition-all duration-300 hover:translate-x-1 p-2 rounded hover:bg-light-accent/30">
        ...
        <footer className="mt-16 pt-6 border-t border-light-accent text-sm text-secondary text-center relative">
